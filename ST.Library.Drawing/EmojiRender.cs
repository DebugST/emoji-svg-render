...
{
    public class EmojiRender : IDisposable
    {
        ...
        public void DrawEmoji(Graphics g, string strChar, int nX, int nY, int nWidth, bool bSelected) {
            ...
            g.DrawImage(
                ci.Image,
                new Rectangle(nX, nY, nWidth, nWidth),
                0, 0, nWidth, nWidth,
                GraphicsUnit.Pixel,
                bSelected ? m_img_attr_selected : m_img_attr_normal);
        }
